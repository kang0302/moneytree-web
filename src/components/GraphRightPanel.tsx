...
/* ─────────────────────────────────────────
   BAROMETER 추세 차트 — 기간별(3Y/1Y/YTD/1M/15D/7D/3D/1D) overall score 시계열
───────────────────────────────────────── */
const TREND_PERIODS: PeriodKey[] = ["3Y", "1Y", "YTD", "1M", "15D", "7D", "3D", "1D"];
const TREND_LABELS: Record<PeriodKey, string> = {
  "3Y": "3년", "1Y": "1년", "YTD": "YTD", "1M": "1개월", "15D": "15일", "7D": "7일", "3D": "3일", "1D": "1일",
};
